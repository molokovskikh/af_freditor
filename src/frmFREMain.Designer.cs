namespace FREditor
{
    ...
    partial class frmFREMain
    {
        ...
        this.PCCostCode};
			...
			this.tbSynonyms.TextChanged += new System.EventHandler(this.txtBoxNameMask_TextChanged);
			// 
			// tbRules
			// 
			...
			this.tbRules.TextChanged += new System.EventHandler(this.txtBoxNameMask_TextChanged);
			// 
			// groupBox2
			// 
			...
			this.cFRFieldNameDataGridViewTextBoxColumn.HeaderText = "CFRFieldName";
			...
			this.cFRTextBeginDataGridViewTextBoxColumn.HeaderText = "CFRTextBegin";
			...
			this.cFRTextEndDataGridViewTextBoxColumn.HeaderText = "CFRTextEnd";
			...
			this.txtBoxQuantity.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dtSet, "Поставщики.Поставщики-Прайсы.Прайсы-правила.FRFQuantity", true));
