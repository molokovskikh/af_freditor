namespace FREditor
{
    ...
    partial class frmFREMain
    {
        ...
        this.PCCostCode};
            ...
            this.txtBoxCodeCrEnd.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dtSet, "Поставщики.Поставщики-Прайсы.Прайсы-правила.FRTxtCodeCrEnd", true));
